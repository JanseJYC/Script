...
function library.NEWS(library, name, theme)
    ...
    Background = Color3.fromRGB(30, 30, 30)  -- 深灰色背景
    zyColor = Color3.fromRGB(45, 45, 45)     -- 中灰色
    beijingColor = Color3.fromRGB(100, 100, 100)  -- 浅灰色
    TextColor = Color3.fromRGB(255, 255, 255)  -- 白色文字，更清晰
    interfaceTransparency = 0.3  -- 降低透明度，让背景更可见
    NameTransparency = 0
    ...
    CloudMain.BackgroundTransparency = 0.15  -- 半透明效果
    CloudMain.BorderColor3 = MainColor
    CloudMain.Position = UDim2.new(0.5, 0, 0.5, 0)
    CloudMain.Size = UDim2.new(0, 400, 0, 250)  -- 改小到 400x250
    CloudMain.ZIndex = 1
    ...
    UIGradient.Color = 
    ColorSequence.new {
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(169, 169, 169)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(105, 105, 105)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(169, 169, 169))
    }
    ...
    function toggleui()
        ...
        Tween(
            ...
            {0.3, "Sine", "InOut"},
            {
                Size = UDim2.new(0, 400, 0, (toggled and 350 or 250))  -- 调整展开尺寸
            }
        )
    end
    ...
    TabMain.Position = UDim2.new(0.25, 0, 0, 3)  -- 调整位置
    TabMain.Size = UDim2.new(0, 300, 0, 250)  -- 调整大小
    ...
    SB.Size = UDim2.new(0, 8, 0, 250)  -- 调整高度
    ...
    Side.Size = UDim2.new(0, 90, 0, 250)  -- 调整侧边栏宽度
    ...
    TabBtns.Size = UDim2.new(0, 90, 0, 215)  -- 调整按钮区域
    ...
    ScriptTitle.Size = UDim2.new(0, 85, 0, 18)  -- 调整标题大小
    ...
    Open.BackgroundTransparency = 0.2  -- 半透明
    Open.Position = UDim2.new(0.008, 0, 0.311, 0)
    Open.Size = UDim2.new(0, 50, 0, 50)  -- 圆形大小
    ...
    OpenCorner.CornerRadius = UDim.new(1, 0)  -- 完全圆形
    ...
    OpenStroke.Color = Color3.fromRGB(169, 169, 169)  -- 灰色边框
    ...
    MainStroke.Color = Color3.fromRGB(100, 100, 100)  -- 灰色边框
    ...
    function window.Tab(window, name, icon)
        ...
        TabText.Size = UDim2.new(0, 60, 0, 20)  -- 缩小文字
        ...
        function tab.section(tab, name, TabVal)
            ...
            Section.Size = UDim2.new(0.98, 0, 0, 30)  -- 缩小section高度
            ...
            if TabVal ~= false then
                Section.Size = UDim2.new(0.98, 0, 0, open and 30 + ObjsL.AbsoluteContentSize.Y + 6 or 30)
            ...
            ObjsL:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(
                function()
                    ...
                    Section.Size = UDim2.new(0.98, 0, 0, 30 + ObjsL.AbsoluteContentSize.Y + 6)
                end
            )
            ...
            function section.Button(section, text, callback)
                ...
                BtnModule.Size = UDim2.new(0, 285, 0, 30)  -- 缩小按钮

                Btn.Name = "Btn"
                Btn.Parent = BtnModule
                Btn.BackgroundColor3 = zyColor
                Btn.BorderSizePixel = 0
                Btn.Size = UDim2.new(0, 285, 0, 30)
            ...
            function section:Label(text)
                ...
                LabelModule.Size = UDim2.new(0, 285, 0, 16)
                
                TextLabel.Parent = LabelModule
                TextLabel.Transparency = interfaceTransparency
                TextLabel.BackgroundColor3 = zyColor
                TextLabel.Size = UDim2.new(0, 285, 0, 18)
            ...
            function section.Toggle(section, text, flag, enabled, callback)
                ...
                ToggleModule.Size = UDim2.new(0, 285, 0, 30)

                ToggleBtn.Name = "ToggleBtn"
                ToggleBtn.Parent = ToggleModule
                ToggleBtn.BackgroundColor3 = zyColor
                ToggleBtn.BorderSizePixel = 0
                ToggleBtn.Size = UDim2.new(0, 285, 0, 30)
                ...
                ToggleDisable.Position = UDim2.new(0.86, 0, 0.2, 0)
                ...
                ToggleSwitch.Size = UDim2.new(0, 18, 0, 18)  -- 正方形作为圆形基础
                ToggleSwitch.Position = UDim2.new(0, 0, 0, 0)

                ToggleSwitchC.CornerRadius = UDim.new(1, 0)  -- 圆形
                ToggleSwitchC.Name = "ToggleSwitchC"
                ToggleSwitchC.Parent = ToggleSwitch

                ToggleDisableC.CornerRadius = UDim.new(1, 0)  -- 圆形背景
                ...
                local funcs = {
                    SetState = function(self, state)
                        ...
                        -- 计算移动位置 (从左侧0到右侧减去开关宽度)
                        local targetPos = state and UDim2.new(1, -18, 0, 0) or UDim2.new(0, 0, 0, 0)
                        ...
                        services.TweenService:Create(
                            ...
                            {
                                Position = targetPos,
                                BackgroundColor3 = (state and Color3.fromRGB(150, 150, 150) or beijingColor)  -- 灰色调
                            }
                        ):Play()
            ...
            function section.Keybind(section, text, default, callback)
                ...
                KeybindModule.Size = UDim2.new(0, 285, 0, 30)

                KeybindBtn.Name = "KeybindBtn"
                KeybindBtn.Parent = KeybindModule
                KeybindBtn.BackgroundColor3 = zyColor
                KeybindBtn.BorderSizePixel = 0
                KeybindBtn.Size = UDim2.new(0, 285, 0, 30)
            ...
            function section.Textbox(section, text, flag, default, callback)
                ...
                TextboxModule.Size = UDim2.new(0, 285, 0, 30)

                TextboxBack.Name = "TextboxBack"
                TextboxBack.Parent = TextboxModule
                TextboxBack.BackgroundColor3 = zyColor
                TextboxBack.BorderSizePixel = 0
                TextboxBack.Size = UDim2.new(0, 285, 0, 30)
            ...
            function section.Slider(section, text, flag, default, min, max, precise, callback)
                ...
                SliderModule.Size = UDim2.new(0, 285, 0, 30)

                SliderBack.Name = "SliderBack"
                SliderBack.Parent = SliderModule
                SliderBack.BackgroundColor3 = zyColor
                SliderBack.BorderSizePixel = 0
                SliderBack.Size = UDim2.new(0, 285, 0, 30)
                ...
                SliderPart.Size = UDim2.new(0, 35, 0, 8)
                ...
                SliderValBG.Position = UDim2.new(0.84, 0, 0.15, 0)
                SliderValBG.Size = UDim2.new(0, 35, 0, 20)
                ...
                MinSlider.Position = UDim2.new(0.27, 20, 0.2, 0)
                MinSlider.Size = UDim2.new(0, 15, 0, 15)
                ...
                AddSlider.Position = UDim2.new(0.77, 0, 0.5, 0)
                AddSlider.Size = UDim2.new(0, 15, 0, 15)
            ...
            function section.Dropdown(section, text, flag, options, callback)
                ...
                DropdownModule.Size = UDim2.new(0, 285, 0, 30)

                DropdownTop.Name = "DropdownTop"
                DropdownTop.Parent = DropdownModule
                DropdownTop.BackgroundColor3 = zyColor
                DropdownTop.BorderSizePixel = 0
                DropdownTop.Size = UDim2.new(0, 285, 0, 30)
                ...
                DropdownOpen.Size = UDim2.new(0, 15, 0, 15)
                ...
                local ToggleDropVis = function()
                    ...
                    DropdownModule.Size =
                        UDim2.new(0, 285, 0, (open and DropdownModuleL.AbsoluteContentSize.Y + 4 or 30))
                end
                ...
                DropdownModuleL:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(
                    function()
                        ...
                        DropdownModule.Size = UDim2.new(0, 285, 0, (DropdownModuleL.AbsoluteContentSize.Y + 4))
                    end)
                ...
                funcs.AddOption = function(self, option)
                    ...
                    Option.Size = UDim2.new(0, 285, 0, 20)
